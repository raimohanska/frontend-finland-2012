...
$(function() {
  ...
  position = direction.sample(20).filter(".isNonZero").scan(v(200, 200), ".add")

  r = new Raphael(100, 100, 400, 400)
  man = r.image("images/man-left-1.png", 100, 100, 40, 40)
  position.onValue( function(pos) { man.attr({ x : pos.x, y : pos.y }) } )
  angle = direction.filter(".isNonZero").map(".getAngleDeg")
  angle.onValue(function(angle) { man.rotate(angle + 180, true) })
